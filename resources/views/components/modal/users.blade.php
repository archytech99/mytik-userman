<div class="modal fade bs-add-users" tabindex="-1" role="dialog" aria-labelledby="modalUsers" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0">Tambah Voucher Baru</h5>
            ...
            <div class="modal-body">
                <form id="formAddPacket" action="{{ route('users') }}" method="post" novalidate="">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" class="form-control" id="comment" name="comment" required="" placeholder="isi keterangan voucher baru ...">
                        </div>
                    </div>
